# =========================================================
# ABC GAMING - SCRAPER COMPLETO
# Adaptado para GitHub Actions (sin Google Colab)
...
def limpiar_precio(precio_txt):
    ...
    if not numero:
        return None, moneda
    valor = numero.group().replace(".", "").replace(",", ".")
    try:
        return float(valor), moneda
    except:
        return None, moneda
...
# =========================================================
# SCRAPERS SINCRONOS (requests + BeautifulSoup)
# =========================================================
        ...
        try:
            ...
            for p in data.get("products", []):
                try:
                    ...
                    productos.append({
                        "nombre": p["title"],
                        "precio_original": f"{precio_raw} USD",
                        "precio": precio_raw,
                        "moneda": "USD",
                        "precio_uyu": convertir_uyu(precio_raw, "USD"),
...
def scrape_flatsome_requests(url, paginas=PAGINAS):
    return scrape_woocommerce(url, paginas)

# =========================================================
# SCRAPER TIENDANEGOCIO (zonadigitalmd.com)
# =========================================================

def scrape_tiendanegocio(url, paginas=PAGINAS):
    productos = []
...
CATALOGOS = {
    ...
    # ---- JUEGOSDIGITALESPS4PS5 (WooCommerce) ----
    "JDP4P5 PS4":               {"tipo": "woocommerce", "url": "https://juegosdigitalesps4ps5.com/juegos-ps4/"},
    "JDP4P5 PS5":               {"tipo": "woocommerce", "url": "https://juegosdigitalesps4ps5.com/juegos-ps5/"},
    "JDP4P5 Switch":            {"tipo": "woocommerce", "url": "https://juegosdigitalesps4ps5.com/juegos-nintendo/"},
    "JDP4P5 PS Plus":           {"tipo": "woocommerce", "url": "https://juegosdigitalesps4ps5.com/membresias-ps-plus/"},
    "JDP4P5 GamePass":          {"tipo": "woocommerce", "url": "https://juegosdigitalesps4ps5.com/membresias-game-pass/"},
    "JDP4P5 Nintendo Online":   {"tipo": "woocommerce", "url": "https://juegosdigitalesps4ps5.com/suscripcion-nintendo-online/"},

    # ---- JUEGOSDIGITALESURUGUAY (WooCommerce) ----
    "UruguayDigital PS3":       {"tipo": "woocommerce", "url": "https://juegosdigitalesuruguay.com/categorias/juegos-digitales-ps3"},
    "UruguayDigital PS4":       {"tipo": "woocommerce", "url": "https://juegosdigitalesuruguay.com/categorias/juegos-digitales-ps4"},
    "UruguayDigital PS5":       {"tipo": "woocommerce", "url": "http://juegosdigitalesuruguay.com/categorias/juegos-digitales-ps5"},
    "UruguayDigital Switch1":   {"tipo": "woocommerce", "url": "https://juegosdigitalesuruguay.com/categorias/nintendo-switch/juegos-nintendo-switch"},
    "UruguayDigital Switch2":   {"tipo": "woocommerce", "url": "https://www.juegosdigitalesuruguay.com/categorias/nintendo-switch-2"},
    "UruguayDigital Xbox One":  {"tipo": "woocommerce", "url": "https://juegosdigitalesuruguay.com/categorias/xbox/juegos-xbox-one"},
    "UruguayDigital Xbox XS":   {"tipo": "woocommerce", "url": "https://juegosdigitalesuruguay.com/categorias/xbox/juegos-xbox-series-xs"},
    "UruguayDigital PSN Plus":  {"tipo": "woocommerce", "url": "https://juegosdigitalesuruguay.com/categorias/cuenta-psn-plus-global"},
    "UruguayDigital Nintendo":  {"tipo": "woocommerce", "url": "https://juegosdigitalesuruguay.com/categorias/nintendo-membresia"},
    "UruguayDigital GamePass":  {"tipo": "woocommerce", "url": "https://juegosdigitalesuruguay.com/categorias/membresias-xbox"},

    # ---- MDQ STORE (WooCommerce) ----
    ...
    # ---- PORTAL GAMES (WooCommerce / Flatsome) ----
    ...
    # ---- TODO DIGITAL SHOP (WooCommerce / Flatsome) ----
    ...
    # ---- ZONADIGITALMD (TiendaNegocio) ----
    "ZonaDigital PS4":          {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/juegosps4"},
    "ZonaDigital PS5":          {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/juegosps5"},
    "ZonaDigital PC Codigo":    {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/juegospccodigo"},
    "ZonaDigital PC Cuenta":    {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/juegospccuenta"},
    "ZonaDigital Xbox":         {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/juegosxbox"},
    "ZonaDigital Apex":         {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/monedasapexlegends"},
    "ZonaDigital Fortnite VB":  {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/fortnitevbucks"},
    "ZonaDigital Fortnite":     {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/cargafortnite"},
    "ZonaDigital GiftCard PSN": {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardps3ps4ps5"},
    "ZonaDigital GiftCard Steam":{"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardsteam"},
    "ZonaDigital Roblox":       {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardroblox"},
    "ZonaDigital GiftCard Xbox":{"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardxbox"},
    "ZonaDigital BattleNet":    {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardbattlenet"},
    "ZonaDigital Riot":         {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardriotlatam"},
    "ZonaDigital FreeFire":     {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardfreefire"},
    "ZonaDigital Google Play":  {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardgoogleplayusa"},
    "ZonaDigital Apple":        {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardappleusa"},
    "ZonaDigital Switch":       {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/nintendoswitch"},
    "ZonaDigital Switch USA":   {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/giftcardusa"},
    "ZonaDigital GamePass":     {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/suscripcioncodigo"},
    "ZonaDigital EA Play":      {"tipo": "tiendanegocio", "url": "zonadigitalmd.com/productos/eaplaycodigo"},
}
...
async def main():
    ...
    # --------------------------------------------------
    # Playwright generico para WooCommerce / Flatsome
    # --------------------------------------------------

    async def scrape_playwright(url, paginas=PAGINAS):
        prods = []
        selectors = [
            "li.product", "div.product", ".product-small",
            ".type-product", ".product-grid-item", ".wd-product", ".product-item"
    ...
    # --------------------------------------------------
    # PARTE 1: CATALOGO MAESTRO + TIENDAS EXTRA
    # --------------------------------------------------
    ...
    for nombre_tienda, cfg in CATALOGOS.items():
        ...
        try:
            ...
            if tipo == "shopify":
                productos = scrape_shopify(url)
            elif tipo == "tiendanube":
                productos = scrape_tiendanube(url)
            elif tipo == "tiendanegocio":
                productos = scrape_tiendanegocio(url)
            elif tipo == "playwright":
                productos = await scrape_playwright(url)
            else:
                # woocommerce: intentar con requests, si da 0 usar playwright
                productos = scrape_woocommerce(url)
                if len(productos) == 0:
    ...
    async with async_playwright() as pw:
        ...
        for categoria, url, tipo in PAGINAS_ENEBA:
            print(f"  Eneba {categoria}...", end=" ", flush=True)
            try:
                page = await browser.new_page(
                ...
                if tipo == "producto":
                    ...
                    for card in cards:
                        try:
                            ...
                            valor, moneda = limpiar_precio(precio)
                            todos.append({
                                "nombre": nombre,
    ...
    # Mejor precio por juego (nombre normalizado)
    idx_mejores = df.groupby("nombre_normalizado")["precio_uyu"].idxmin()
    mejores = df.loc[idx_mejores].sort_values("precio_uyu").copy()

    COLS_DISPLAY = ["fuente", "tienda", "nombre", "nombre_normalizado", "precio_original", "precio_uyu", "moneda", "plataforma", "link"]
    COLS_LABELS  = ["Fuente", "Tienda", "Nombre", "Nombre Limpio", "Precio Original", "Precio UYU", "Moneda", "Plataforma", "Link"]
    ...
    with pd.ExcelWriter(ARCHIVO, engine="openpyxl") as writer:
        ...
        # Hoja TODO
        df[COLS_DISPLAY].rename(columns=dict(zip(COLS_DISPLAY, COLS_LABELS))).to_excel(
            writer, sheet_name="TODO", index=False
        )

        # Hoja MEJORES PRECIOS
        mejores[COLS_DISPLAY].rename(columns=dict(zip(COLS_DISPLAY, COLS_LABELS))).to_excel(
        ...
        if len(eneba_df) > 0:
            eneba_df[COLS_DISPLAY].rename(columns=dict(zip(COLS_DISPLAY, COLS_LABELS))).to_excel(
        ...
        for plataforma in sorted(df["plataforma"].unique()):
            ...
            temp[COLS_DISPLAY].rename(columns=dict(zip(COLS_DISPLAY, COLS_LABELS))).to_excel(
                writer, sheet_name=nombre_hoja, index=False
            )

    # Formateo visual con openpyxl
